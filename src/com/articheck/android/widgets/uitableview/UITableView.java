...
{
    private UITableView     mMyself = this;
    ...
    public void commit()
    {
        if (mTitle != null)
        {
            TextView text_view = (TextView) mInflater.inflate(
            ...
            view.setOnClickListener(new View.OnClickListener()
            {
                ...
                public void onClick(View view)
                {
                    if (mClickListener != null)
                        mClickListener.onClick((Integer) view.getTag(), mMyself);
                }
    ...
    {
        void onClick(int index, View this_view);
    }
